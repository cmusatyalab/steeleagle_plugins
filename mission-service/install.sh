...
GO_VERSION=1.26.5
# Matches core/util/env.go's GetDataDir: $XDG_DATA_HOME/steeleagle (defaulting
# to ~/.local/share/steeleagle), the same persistent data directory eagled
# itself uses.
TOOLCHAIN_DIR="${XDG_DATA_HOME:-$HOME/.local/share}/steeleagle/go-toolchain"
